...
//	***********create cartogram using deformation grid************
                    ...
                    while (k++ < (districts - 1)) {	  //***************deform the districts one-by-one
                    ...
                    k = -1;
                    while (k++ < (districts - 1)) {     //****************convert geographic coordinates to SVG coordinates to prevent D3 from resampling
                    ...
                    let worldmap = svg.selectAll("path")      //plot the map
