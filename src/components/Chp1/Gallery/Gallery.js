            ...
            <Modal isOpen={isModalOpen3c} toggle={toggleModal3c}>
                <ModalSection>
                    ...
                    <ModalTextContainer>
                        ...
                        <Divider />
                        <ModalScript>
                            “부산은 대도시이지만, 2021년, 2022년이 되면 초고령사회로 진입할 것이기 때문에, 
                            노인이 많은 지역이고 바다를 끼고 있어서 ‘노인과 바다’ 그런 얘기가 나와요.”
                        </ModalScript>                    
                    </ModalTextContainer>
                </ModalSection>
            </Modal>
            ...
            <Modal isOpen={isModalOpen3e} toggle={toggleModal3e}>
                <ModalSection>
                    ...
                    <ModalTextContainer>
                        ...
                        <Divider />
                        <ModalScript>
                            "(빈집에) 노숙자들이 들어와서 술도 마셔요. 어디 사람인지도 몰라요. 항상 겁이 나는 게, 
                            겨울에 담배꽁초 하나라도 던지면 빈집만 타는 게 아니라 온 동네로 불이 번지니까."
                        </ModalScript>                    
                    </ModalTextContainer>
                </ModalSection>
            </Modal>
            ...
            <Modal isOpen={isModalOpen2d} toggle={toggleModal2d}>
                <ModalSection>
                    ...
                    <ModalTextContainer>
                        ...
                        <Divider />
                        <ModalScript>
                            "3만 명이 안 되는 자리에 상가들이 보시다시피 너무 많이 건축이 되다 보니까, 공실이 발생될 수 밖에 없는 거예요"                        
                        </ModalScript>                    
                    </ModalTextContainer>
                </ModalSection>
            </Modal>
            ...
            <Modal isOpen={isModalOpen2e} toggle={toggleModal2e}>
                <ModalSection>
                    ...
                    <ModalTextContainer>
                        ...
                        <Divider />
                        <ModalScript>
                            "숙녀복, 메리야스, 란제리 같은 것을 팔았어요. 장사가 잘 안되다 보니까 개인파산 신청을 하고 나갔어요."
                        </ModalScript>                    
                    </ModalTextContainer>
                </ModalSection>
            </Modal>
            ...
            <Modal isOpen={isModalOpen1d} toggle={toggleModal1d}>
                <ModalSection>
                    ...
                    <ModalTextContainer>
                        ...
                        <Divider />
                        <ModalScript>
                            "이 병원이 없다고 보면 상당히 불안하죠. 목숨 마저도 정부에서 차별을 한다고 하면 정말로 분개하지 않을 수가 없죠."
                        </ModalScript>                    
                    </ModalTextContainer>
                </ModalSection>
            </Modal>
            ...
            <Modal isOpen={isModalOpen1e} toggle={toggleModal1e}>
                <ModalSection>
                    ...
                    <ModalTextContainer>
                        ...
                        <Divider />
                        <ModalScript>
                            "(인구 감소로) 이 병원이 없어지면 우리 하동은 치명적입니다. 이 병원이 꼭 유지가 돼야해요. 
                            문을 닫는 경우가 생겨서는 안 되죠."
                        </ModalScript>                    
                    </ModalTextContainer>
                </ModalSection>
