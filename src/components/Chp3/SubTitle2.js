            ...
            <Section>  
                <Container>
                    <TextWrapper>
                        ...
                        <Paragraph>
                            <Line>
                                사정이 이렇다보니, 이제 수도권에는 자녀 계획을 꺼리는 청년들이 늘어나기 시작했습니다. 출산과 보육 등에 쏟는 에너지를 자신에게 쏟기로 한 것이죠.&nbsp;                   
                            </Line>
                            <Underline>
                                높은 인구밀도가 낳는 경쟁에서 살아남기 위해, 출산을 포기하는 겁니다.
                            </Underline>
                        </Paragraph>
                    ...
                    <ImageWrapper>
                        ...
                        <RetouchedImage src={card11} alt="신혼부부 이야기 열한번째 컷" style={{paddingBottom: 0}} />
                    </ImageWrapper>
                </Container>
            </Section>
        </Fragment>
