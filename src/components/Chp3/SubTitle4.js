...
const Text = ({background}) => {
    ...
    useEffect(() => {
        width > 265 
        ? setTitle(<>혁신도시 인구,<br />다시 수도권으로 유출</>) 
            ...
            <Section>  
                <Container>
                    <TextWrapper>
                        ...
                        <Paragraph>
                            <Line>
                                정부가 이 같은 수도권 쏠림 현상을 그대로 내버려뒀던 것은 아닙니다. 2003년 참여정부는 수도권에 집중된 자원을 분산하기 위해 균형발전 정책의 일환으로 ‘혁신도시’ 카드를 꺼내들었습니다. 전국 자치단체 10곳에 공공기관 112개를 내려 보냈고, 지난해(2020년) 이전이 마무리됐습니다.                          
                            </Line>
                        </Paragraph>
                        <Paragraph>
                            <Line>
                                하지만 인구 분산 효과는 크지 않았습니다.&nbsp;                     
                            </Line>
                            <Underline>
                                매주 금요일 밤이면 진주와 나주, 세종 등 전국 거의 모든 혁신도시에서 대이동이 시작됩니다.
                            </Underline>
                            <Line>
                                &nbsp; 가족과 주말을 보내기 위해 서울과 수도권으로 향하는 직원들을 위한 단체 통근버스 행렬입니다. 주말에는 혁신도시에서 아예 인적을 찾기 어렵습니다.   
                            </Line>
                        </Paragraph>
