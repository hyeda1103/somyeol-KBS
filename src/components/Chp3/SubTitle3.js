      ...
      <Section>
        <Container>
          <TextWrapper>
            ...
            <Paragraph>
              <Line>
                손승민·박홍미 부부의 사례처럼, 인구 밀도는 출산율에 큰 영향을
                미치고 있습니다. 서울대학교 조영태 교수 연구진은 ‘2019년 전국
                기초자치단체의 출산율과 인구밀도의 상관관계’를 분석했습니다.
              </Line>
            </Paragraph>
            <Paragraph style={{ marginBottom: 0 }}>
              <Line>
                그 결과, 인구 밀도가 높을수록 출산율은 낮고, 인구 밀도가
                낮을수록 출산율은 높아졌습니다.&nbsp;
              </Line>
              <Underline>
                사람이 많으면 한정된 자원을 두고 경쟁이 치열해지기 때문에, ‘생존
                본능’이 출산이라는 ‘재생산 본능’을 앞서게 된 것입니다.
              </Underline>
            </Paragraph>
            ...
            <Paragraph style={{ marginBottom: 0 }}>
              <Line>
                지난해 우리나라 합계출산율은 아이 한 명도 낳지 않는 0.84명.
                심지어 사망자 수가 출생아 수보다 더 많아 ‘인구 데드크로스’도
                처음 발생했습니다.&nbsp;
              </Line>
              <Underline>
                만약, 인구와 자원이 이대로 수도권에 집중되면, 30~40년 뒤 인구는
                우리나라 사회를 지탱할 수 없을 지도 모릅니다.
              </Underline>
            </Paragraph>
            {/* 우리나라 인구 사상 첫 자연 감소 */}
