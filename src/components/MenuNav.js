...
const MenuNav = ({ open }) => {
  ...
  useEffect(() => {
        ...
        const expandSize = () => {
            if(window.scrollY >= 60&&window.scrollY < winHeightPx - window.innerHeight) {
                setExpand(true)
            } else {
                setExpand(false)
            }
...
return (
    <GrandParent>
      <Parent expand={expand} open={open} left='0' delay='0'>
        <CardSection bg={chp1}>
          <Container>
          <HeroContent to="/chp1" onClick={ location.pathname==="/chp1" ? reloadPage : null } >                            
            <h1 data-aos='fade-down' data-aos-duration='600'>Chapter1</h1>
      ...
      <Parent expand={expand} open={open} left='calc(100vw / 3)' delay='0.1s'>
        <CardSection bg={chp2}>
          <Container>
          <HeroContent to="/chp2" onClick={ location.pathname==="/chp2" ? reloadPage : null } >
            <h1 data-aos='fade-down' data-aos-duration='600'>Chapter2</h1>
      ...
      <Parent expand={expand} open={open} left='calc(200vw / 3)' delay='0.2s'>
        <CardSection bg={chp3}>
          <Container>
          <HeroContent to="/chp3" onClick={ location.pathname==="/chp3" ? reloadPage : null } >
            <h1 data-aos='fade-down' data-aos-duration='600'>Chapter3</h1>
...
const Parent = styled.div`
  ...
  @media screen and (max-width: 425px){
    ...
    height: ${({ expand }) => expand ? `calc((100vh - 60px)/3)` : `calc((100vh - 88px) / 3)`};
    width: 100vw;
    left: 0;
    ...
    &:nth-child(2) {
      top: ${({ expand }) => expand ? `calc((100vh - 60px) / 3)` : `calc((100vh - 88px) / 3)`};
    }

    &:nth-child(3) {
      top: ${({ expand }) => expand ? `calc((100vh - 60px) * 2 / 3)` : `calc((100vh - 88px) * 2 / 3)`};
    }
  }
`
